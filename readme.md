...
![OHOS](https://img.shields.io/badge/OpenAtom-OpenHarmony-green?style=flat-square&logo=Huawei)
![miniprogram](https://img.shields.io/badge/WeChat-Mini%20Program-green?style=flat-square&logo=WeChat)
...
## 第一部分  设计概述
### 1.1	设计目的
商品售卖机，又称自动售货机，自发明以来得到了广泛流行，给人类生活带来了极大方便。然而，在当今新冠肺炎疫情的背景下，自动售货机按钮、 触屏的交互方式要求用户直接接触设备，存在一定疫情传播风险，因此需要[1] 设计一种无接触的交互方式以降低疫情传播风险、保护用户个人健康。我们利用 Hi3516DV300 计算机视觉与 Hi3861V100 WiFi-IoT 开发套件设计了一种利用手势进行交互的智能商品售卖机，可通过手势识别实现商品选择等功能，选择商品、支付成功后自动出货，达到了无接触交互的目的，安全卫生、交互方便。同时，我们采用了物联网技术，实现了数据上传、数据分析、远程数据更新等功能，使作品具备了智能化的特点。

### 1.2	应用领域
自动售货机本身具有可售商品范围广泛、部署便捷、低成本的特点[2]，可应用于各类公共场所，具有极广泛的应用场景，并有助于提升生产总值、促进经济发展[3]。本作品具备上述特点的同时，采用了无接触交互，尤其适用于医院、机场、火车站等人流量大、对公共卫生要求高的特殊公共场所，可在方便顾客使用、促进零售业发展的同时确保用户的个人健康安全，降低疫情传播风险。
