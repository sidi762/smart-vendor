...
Page({
    ...
    startDataUpdateTimer: function () {
        var that = this 
        that.data.dataUpdateTimer = setInterval(
            function () {
    ...
    sendDataRequest: function () {
        ...
        this.data.client.publish(this.data.shadowReqTopic, JSON.stringify(requestMsg)) 
    },
    ...
    processShadowMessage() {
        ...
        if (received.type == "get") {
            this.data.name1 = received.payload.state.reported.product_info[0].product_name 
            this.setData({
                name1: this.data.name1
            }) 
            this.data.name2 = received.payload.state.reported.product_info[1].product_name 
            this.setData({
                name2: this.data.name2
            }) 
            this.data.name3 = received.payload.state.reported.product_info[2].product_name 
            this.setData({
                name3: this.data.name3
            }) 
            this.data.name4 = received.payload.state.reported.product_info[3].product_name 
            this.setData({
                name4: this.data.name4
            }) 
            this.data.price1 = received.payload.state.reported.product_info[0].product_price 
            this.setData({
                price1: this.data.price1
            }) 
            this.data.price2 = received.payload.state.reported.product_info[1].product_price 
            this.setData({
                price2: this.data.price2
            }) 
            this.data.price3 = received.payload.state.reported.product_info[2].product_price 
            this.setData({
                price3: this.data.price3
            }) 
            this.data.price4 = received.payload.state.reported.product_info[3].product_price 
            this.setData({
    ...
    reportToShadow: function (msgObj) {
        ...
        if (this.data.client) {
            this.data.client.publish(this.data.shadowReqTopic, JSON.stringify(reportMsg))
